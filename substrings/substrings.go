...
// FindIndices returns a slice of 1-based indices where the subtext is found in the textToSearch
...
func FindIndices(textToSearch, subtext string) []int {
	...
	// lowercase both textToSearch and subtext
